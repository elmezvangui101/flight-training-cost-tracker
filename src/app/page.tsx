      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 relative z-10">
        ...
        <header className="text-center mb-8 slide-in">
          ...
          <div className="flex justify-end mb-4">
            <button
              ...
              className="p-2 rounded-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-700 transition-all duration-200 border border-sky-200 dark:border-sky-800 hover-lift"
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-cockpit-blue via-sky-600 to-horizon-blue bg-clip-text text-transparent">
              Flight Training Cost Tracker
            </h1>
          </div>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 subtitle">
          ...
          <div className="total-display rounded-xl p-6 mb-8 aviation-card">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-3 flex items-center justify-center gap-2">
        ...
        <main role="main" id="main-content">
          <article>
            ...
            {/* Add Expense Form */}
            <section className="aviation-card rounded-xl p-6 mb-8 hover-lift" aria-label="Add expense form">
              <div className="flex items-center gap-2 mb-6">
                <AviationIcon type="plane" size={24} />
                <h2 className="text-xl font-semibold text-cockpit-blue dark:text-sky-400">Log Flight Training Expense</h2>
              </div>
            ...
            {success && (
              <div className="bg-green-50 border border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400 px-4 py-3 rounded mb-4">
                {success}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-900 dark:bg-blue-800 text-white py-3 px-4 rounded-md hover:bg-blue-800 dark:hover:bg-blue-700 active:bg-blue-900 transition-colors font-medium text-lg min-h-[48px]"
              >
                Add Expense
              </button>
            </form>
          ...
          <div className="mb-6 text-center">
            <button
              onClick={exportToCSV}
              className="bg-green-600 text-white py-2 px-6 rounded-md hover:bg-green-700 active:bg-green-800 transition-colors font-medium"
            >
              Export to CSV
            </button>
          </div>
          ...
          {categoryBreakdown.length > 0 && (
            <section className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
              <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Spending by Category</h2>
          ...
          <section className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Expenses</h2>
